...
app.controller('OrderVisualCreateCtrl', ['$scope', '$http', 'toaster', '$state', '$modal', '$log', '$rootScope', 'appTools', 'OrderService', 'areaService',
	function ($scope, $http, toaster, $state, $modal, $log, $rootScope, appTools, OrderService, areaService) {
		$scope.i = 0;
		$scope.form = {};
		$scope.form.member = 0;
		$scope.form.areas = [];
