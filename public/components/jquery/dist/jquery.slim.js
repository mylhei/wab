...
var slice = boxArr.slice;

var concat = boxArr.concat;

var push = boxArr.push;

var indexOf = boxArr.indexOf;
...
jQuery.extend( {
	...
	makeArray: function( arr, results ) {
		...
		if ( boxArr != null ) {
			if ( isArrayLike( Object( boxArr ) ) ) {
				jQuery.merge( ret,
					typeof boxArr === "string" ?
					[ boxArr ] : boxArr
				);
			} else {
				push.call( ret, boxArr );
			}
		}
	...
	inArray: function( elem, arr, i ) {
		return boxArr == null ? -1 : indexOf.call( boxArr, elem, i );
	},
...
if ( typeof Symbol === "function" ) {
	jQuery.fn[ Symbol.iterator ] = boxArr[ Symbol.iterator ];
}
/* jshint ignore: end */
...
try {
	push.apply(
		(boxArr = slice.call( preferredDoc.childNodes )),
		preferredDoc.childNodes
	);
	// Support: Android<4.0
	// Detect silently failing push.apply
	boxArr[ preferredDoc.childNodes.length ].nodeType;
} catch ( e ) {
	push = { apply: boxArr.length ?
...
function addHandle( attrs, handler ) {
	...
	while ( i-- ) {
		Expr.attrHandle[ boxArr[i] ] = handler;
	}
}
